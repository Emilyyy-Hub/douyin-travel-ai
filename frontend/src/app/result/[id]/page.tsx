        ...
        {status === "success" && plan ? (
          <>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-sm font-semibold text-[#bf5f47]">{plan.case.title}</p>
            ...
            <SceneAnalysis scene={plan.sceneAnalysis} />

            <section className="space-y-4">
              <div>
                <p className="text-sm font-semibold text-[#bf5f47]">3 套完整穿搭方案</p>
            ...
            <section className="space-y-4">
              ...
              {plan.actionCards.length > 0 ? (
                <div className="grid gap-4 md:grid-cols-3">
                  {plan.actionCards.map((action) => (
